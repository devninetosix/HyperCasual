...
It is compatible with the format of WOLF RPG Editor.
...
The format is based on that of auto tile system of WOLF RPG Editor (https://www.silversecond.com/WolfRPGEditor/) so you can use assets made for it.


Features -------------------------------------------------------
 - Animation (Random animation speed is also supported)
 - Padding to avoid dirty lines between sprites
 - Custom maps (ex. normal map, emission map)