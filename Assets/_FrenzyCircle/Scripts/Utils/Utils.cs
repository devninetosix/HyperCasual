...
// TODO: 테스트 코드 제거
        ...
        public static string RandomNameGenerator()
        {
            List<string> firstNames = new List<string>()
            {
                ...
                "Samuel", "Aiden", "David", "Owen", "Ezekiel", "Julian", "Luke", "Carter", "Santiago", "Isaiah",
                "Miles",
                "Jayden", "Logan", "Isaac", "Matthew", "John", "Adam", "Nolan", "Nathan", "Caleb", "Joseph", "Cooper",
                "Thomas", "Anthony", "Micah", "Roman", "Lincoln", "Amir", "Olivia", "Emma", "Amelia", "Sophia",
                "Charlotte",
                "Isabella", "Ava", "Mia", "Luna", "Ellie", "Harper", "Camila", "Sofia", "Scarlett", "Elizabeth",
                "Eleanor",
                "Emily", "Chloe", "Mila", "Violet", "Penelope", "Gianna", "Aria", "Abigail", "Ella", "Avery", "Hazel",
                "Nora", "Layla", "Lily", "Aurora", "Nova", "Madison", "Grace", "Isla", "Zoe", "Riley", "Stella",
                "Eliana",
